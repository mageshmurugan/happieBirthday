                                  ...
                                  <div
                                    ...
                                    <table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0"
                                      ...
                                      <tbody>
                                        <tr>
                                          <td
                                            style="overflow-wrap:break-word;word-break:break-word;padding:16px 20px 8px;font-family:'Raleway',sans-serif;"
                                            align="left">
                                            ...
                                            <div
                                              ...
                                              <p style="font-size: 14px; line-height: 120%;"><strong><span
                                                    ...
                                                    Birthday ${datq.names}</span></strong></p>
                                            </div>
                                    ...
                                    <table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0"
                                      ...
                                      <tbody>
                                        <tr>
                                          <td
                                            style="overflow-wrap:break-word;word-break:break-word;padding:22px 0px 0px;font-family:'Raleway',sans-serif;"
                                            align="left">
                                    ...
                                    <table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0"
                                      ...
                                      <tbody>
                                        <tr>
                                          <td
                                            style="overflow-wrap:break-word;word-break:break-word;padding:15px 20px 14px;font-family:'Raleway',sans-serif;"
                                            align="left">
              
                                            <div
                                              style="color: #ffffff; line-height: 120%; text-align: center; word-wrap: break-word;">
                                              <p style="font-size: 14px; line-height: 120%;"><span
                                                  style="font-size: 28px; line-height: 36px;">Hope all your birthday wishes come
                                                  true!</span></p>
                                            </div>
                                          ...
                                          <td
                                            ...
                                            <div
                                              ...
                                              <p style="font-size: 14px; line-height: 130%;"><span
                                                  style="font-size: 16px; line-height: 20.8px;">It is a automated email</span></p>
                                              <p style="font-size: 14px; line-height: 130%;"><span
                                                  style="font-size: 16px; line-height: 20.8px;"> -Created By Magesh</span></p>
                                            </div>
                                          ...
                                          <td
                                            ...
                                            <div
                                              ...
                                              <p style="font-size: 14px; line-height: 140%;"><span
                                                  style="font-size: 18px; line-height: 25.2px;">To Automate a Birthday wishes for your
                                                  friends</span></p>
                                              <p style="font-size: 14px; line-height: 140%;"><span
                                                  style="font-size: 18px; line-height: 25.2px;">Click the link below.</span></p>
                                            </div>
                                  ...
                                  <div
                                    ...
                                    <table style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0"
                                      ...
                                      <tbody>
                                        <tr>
                                          <td
                                            style="overflow-wrap:break-word;word-break:break-word;padding:15px 20px 20px;font-family:'Raleway',sans-serif;"
                                            align="left">
